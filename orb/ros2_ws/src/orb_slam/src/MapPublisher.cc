...
MapPublisher::MapPublisher(Map* pMap):mpMap(pMap), mbCameraUpdated(false)
{
    ...
    mPoints.id=0;
    mPoints.type = visualization_msgs::msg::Marker::POINTS;
    mPoints.scale.x=fPointSize;
    mPoints.scale.y=fPointSize;
    mPoints.pose.orientation.w=1.0;
    mPoints.action=visualization_msgs::msg::Marker::ADD;
    mPoints.color.a = 1.0;
    ...
    mKeyFrames.id=1;
    mKeyFrames.type = visualization_msgs::msg::Marker::LINE_LIST;
    mKeyFrames.scale.x=0.005;
    mKeyFrames.pose.orientation.w=1.0;
    mKeyFrames.action=visualization_msgs::msg::Marker::ADD;
    ...
    mCovisibilityGraph.type = visualization_msgs::msg::Marker::LINE_LIST;
    mCovisibilityGraph.scale.x=0.002;
    mCovisibilityGraph.pose.orientation.w=1.0;
    mCovisibilityGraph.action=visualization_msgs::msg::Marker::ADD;
    ...
    mMST.id=3;
    mMST.type = visualization_msgs::msg::Marker::LINE_LIST;
    mMST.scale.x=0.005;
    mMST.pose.orientation.w=1.0;
    mMST.action=visualization_msgs::msg::Marker::ADD;
    mMST.color.b=0.0f;
    mMST.color.g=1.0f;
    mMST.color.a = 1.0;
    ...
    mCurrentCamera.id=4;
    mCurrentCamera.type = visualization_msgs::msg::Marker::LINE_LIST;
    mCurrentCamera.scale.x=0.01;//0.2; 0.03
    mCurrentCamera.pose.orientation.w=1.0;
    mCurrentCamera.action=visualization_msgs::msg::Marker::ADD;
    ...
    mReferencePoints.type = visualization_msgs::msg::Marker::POINTS;
    mReferencePoints.scale.x=fPointSize;
    mReferencePoints.scale.y=fPointSize;
    mReferencePoints.pose.orientation.w=1.0;
    mReferencePoints.action=visualization_msgs::msg::Marker::ADD;
